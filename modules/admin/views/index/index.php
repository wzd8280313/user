...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"><frame src="./index.php?r=admin/index/head"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="./index.php?r=admin/index/left" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="./index.php?r=admin/index/main" name="main" scrolling="yes" noresize="noresize"

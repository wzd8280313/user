...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="<?= ADMIN_IMG_URL ?>coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;-</span>&nbsp;管理员管理
			</div>
		</div>
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr height="40px">
							...
							<td><a href="<?= Url::to(['useradd']); ?>"><img class="operation"
									src="<?= ADMIN_IMG_URL ?>update.png"></a> <img class="operation delban"
								src="<?= ADMIN_IMG_URL ?>delete.png"></td>
						</tr>
					</table>
	...
	<div class="banDel">
		<div class="delete">
			<div class="close">
				<a><img src="<?= ADMIN_IMG_URL?>shanchu.png" /></a>
			</div>

...
class Pregoods extends IController
{
	...
	function products()
	{
		...
		if($product_info)
		{
			...
			$goods_info['maxPresellPrice']= number_format(ceil($money_rate * $product_info['maxSellPrice']),2);
			$goods_info['minPresellPrice']= number_format(ceil($money_rate * $product_info['minSellPrice']),2);
		}

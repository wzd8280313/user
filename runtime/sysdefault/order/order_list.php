	...
	<div class="content">
		<table class="list_table">
			...
			<tbody>
				...
				<?php foreach($this->order_list as $k => $item){?>
				<tr>
					...
					<td>
						...
						<?php if(isset($this->order_refund[$item['id']][0]['refunding'])){?>
						<a href='<?php echo IUrl::creatUrl("/order/refundment_apply_show/id/".$this->order_refund[$item['id']][0]["refunding"]."");?>' class='red'>退货处理</a>
						<?php }elseif(isset($this->order_refund[$item['id']][0]['refunded'])){?>
							<a href='<?php echo IUrl::creatUrl("/order/order_show/id/".$item['id']."");?>?refunds' class='blue'>退货完成</a>
						<?php }?>
						<?php if(isset($this->order_refund[$item['id']][1]['refunding'])){?>
						<a href='<?php echo IUrl::creatUrl("/order/refundment_chg_show/id/".$this->order_refund[$item['id']][1]["refunding"]."");?>' class='red'>换货处理</a>
						<?php }elseif(isset($this->order_refund[$item['id']][1]['refunded'])){?>
						<a href='<?php echo IUrl::creatUrl("/order/order_show/id/".$item['id']."");?>?refunds' class='blue'>换货完成</a>
						<?php }?>

...
<div class="content">
	<form method='post' action='<?php echo IUrl::creatUrl("/market/pro_rule_del");?>' name='pro_rule' >
		<table class="list_table">
			<col width="40px" />
			<col width="150px" />
			<col width="280px" />
			...
			<col width="100px" />
			<tbody>
				<?php $query = new IQuery("promotion");$query->where = "type = 0 and $where";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>

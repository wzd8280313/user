...
<script type="text/javascript" charset="UTF-8" src="/iweb2/runtime/_systemjs/highcharts/highcharts.js"></script>
	...
	<form action='<?php echo IUrl::creatUrl("/market/amount");?>' method='get'>
		...
		<div class="operating">
			<div class="search f_l">
				<input type="text" name='start' class="Wdate" id="date_start" value='<?php echo isset($start)?$start:"";?>' pattern='date' alt='' onFocus="WdatePicker()" onblur="FireEvent(this,'onchange')" /> —— <input type="text" name='end' pattern='date' value='<?php echo isset($end)?$end:"";?>' class="Wdate" id="date_end" onFocus="WdatePicker()" onblur="FireEvent(this,'onchange')" />

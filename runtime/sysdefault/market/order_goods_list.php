		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<p>运费：￥<?php echo isset($item['delivery_fee'])?$item['delivery_fee']:"";?></p>
					<p>保价：￥<?php echo isset($item['save_price'])?$item['save_price']:"";?></p>
					<p>税金：￥<?php echo isset($item['tax'])?$item['tax']:"";?></p>
				</td>
				<?php $sum = array_sum(array($goodsSum,$item['delivery_fee'],$item['save_price'],$item['tax']))?>
				<td title="<?php echo isset($sum)?$sum:"";?>">￥<?php echo isset($sum)?$sum:"";?></td>

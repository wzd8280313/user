	...
	<form action='<?php echo IUrl::creatUrl("/market/spanding_avg");?>' method='get'>
		...
		<div class="operating">
			<div class="search f_l">
				<input type="text" name='start' empty class="Wdate" id="date_start" pattern='date' value="<?php echo isset($start)?$start:"";?>" alt='' onFocus="WdatePicker()" onblur="FireEvent(this,'onchange')" /> —— <input type="text" empty name='end' value="<?php echo isset($end)?$end:"";?>" pattern='date' class="Wdate" id="date_end" onFocus="WdatePicker()" onblur="FireEvent(this,'onchange')" />

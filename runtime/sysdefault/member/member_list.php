...
<body>
	...
	<div class="operating">
		<div class="search f_r">
			<form name="searchuser" action="<?php echo IUrl::creatUrl("/");?>" method="get">
				...
				<select class="auto" name="search">
					...
					<option value="u.phone">手机</option>
		...
		<a href="<?php echo IUrl::creatUrl("/member/bad_member_list");?>" ><button class="operating_btn" type="button"><span class="delete">恶意会员</span></button></a>
	...
	<div class="content">
		<table id="list_table" class="list_table">
			...
			<tbody>
				...
				<?php $query = new IQuery("user as u");$query->join = "left join member as m on m.user_id = u.id";$query->fields = "m.*,u.username,u.phone,u.email";$query->where = "m.status  !=  2 and $where";$query->order = "m.user_id desc";$query->page = "$page";$query->pagesize = "20";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>

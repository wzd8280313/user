				...
				<tbody>
					...
					<tr>
						...
						<input type='file' name='logo_img' />
							<?php if(isset($this->sellerRow['logo_img']) && $this->sellerRow['logo_img']){?>
							<p><a target="_blank" href="<?php echo IUrl::creatUrl("")."";?><?php echo isset($this->sellerRow['logo_img'])?$this->sellerRow['logo_img']:"";?>"><img src='<?php echo IUrl::creatUrl("")."";?><?php echo isset($this->sellerRow['logo_img'])?$this->sellerRow['logo_img']:"";?>' style='width:320px;border:1px solid #ccc' /></a></p>
							<?php }?>
							</td>
					</tr>
					<tr>

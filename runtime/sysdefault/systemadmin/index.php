...
<body id="login">
	<div class="container">
		<div id="header">
			<div class="logo">
				<a href="<?php echo IUrl::creatUrl("");?>"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/logo.png";?>" width="303" height="58" /></a>
			</div>
		</div>
		...
		<div id="footer">Power by <a href="http://www.nainaiwang.com" target="_blank">www.nainaiwang.com</a></div>
	</div>
</body>
</html>

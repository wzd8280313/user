...
<div class="container">
	<div class="header">
		<h1 class="logo"><a title="<?php echo $siteConfig->name;?>" style="background:url(<?php if($siteConfig->logo){?><?php echo IUrl::creatUrl("")."".$siteConfig->logo."";?><?php }else{?><?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/front/logo.gif";?><?php }?>);" href="<?php echo IUrl::creatUrl("");?>"><?php echo $siteConfig->name;?></a></h1>
		<ul class="shortcut">
	...
	seo::set($seo_data);
?>
<div class="position"> <span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>"> 首页</a> » <a href="<?php echo IUrl::creatUrl("/site/article");?>">资讯列表</a> » <?php echo isset($this->articleRow['title'])?$this->articleRow['title']:"";?> </div>
<div class="wrapper clearfix container_2">
	...
	<div class="main f_r">
		<div class="box m_10">
			...
			<div class="cont">
				<div class="c_box">
					<h2><?php echo isset($this->articleRow['title'])?$this->articleRow['title']:"";?></h2>
					<div class="partake_bar clearfix">
						<span class="f_r"></span>发布日期：<?php echo isset($this->articleRow['create_time'])?$this->articleRow['create_time']:"";?>
					</div>
					<hr class="m_10" />
					<div class="textcontent">
						<p><?php echo isset($this->articleRow['content'])?$this->articleRow['content']:"";?></p>
					</div>
				</div>
			</div>
		</div>

		<?php if(!empty($this->relationList)){?>
		<div class="box m_10">
			<div class="title2 m_10">相关商品</div>
			<div class="parts clearfix">
				<ul class="prolist">
					<?php foreach($this->relationList as $key => $item){?>
					<li>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>"><img width="98" height="106" src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/98/h/106");?>" alt="<?php echo isset($item['name'])?$item['name']:"";?>"></a>

...
<body class="second" >
	<div class="brand_list container_2">
		<div class="header">
			...
			<ul class="shortcut">
				<li class="first"><a href="<?php echo IUrl::creatUrl("/ucenter/index");?>" target="_blank">我的账户</a></li>
				<li><a href="<?php echo IUrl::creatUrl("/ucenter/order");?>" target="_blank">我的订单</a></li>
				<li><a href="<?php echo IUrl::creatUrl("/simple/seller");?>" target="_blank">申请开店</a></li>
				<li><a href="<?php echo IUrl::creatUrl("/seller/index");?>" target="_blank">商家管理</a></li>
		   		<li class='last'><a href="<?php echo IUrl::creatUrl("/site/help_list");?>" target="_blank">帮助中心</a></li>
			</ul>
...
function sendMessage()
{
	...
	$.get("<?php echo IUrl::creatUrl("/simple/send_message_mobile");?>",{"mobile":mobile},function(content){
		if(content == 'success')
		{
			alert('发送成功，请查看您的手机');
		}

...
<script>
	...
	<div class="login_wrap">
		<div class="wrap clearfix">
				...
				<div class="login_form">
					...
					<div class="form_item_wrap">
					    ...
					    <div id="vcd_div" class="verify_code" style="display: none;">
					    	...
					    	<div class="form_item">
					        	<label>验证码：</label>
					        	<input id="vcd" type="text" name="validCode" value="" tabindex="-1" class="ipt ipt_code" style="width: 70px; outline: none;" maxlength="5" onblur="javascript: checkValidCodeOnBlur()" onkeyup="javascript: login_param_validate();">
			...
			<div class="mod_left_banner"><a id="imgLink" target="_blank"><img id="img1" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/css/log/login_pic.png";?>" width="400" height="300"></a></div>
		</div>
	</div>

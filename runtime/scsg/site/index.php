		...
		<div class="w1190">
			...
			<div class="right-cnt">
				  ...
				  <ul class="promise" id="promise">
   					<li class="15day">
    					<a style="cursor: pointer;" href="#"><span class="ic"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index_icon_1.png";?>"></span> 7天退换货</a>
    				</li>
    				<li class="baoyou">
    				...
    				<li class="cirida">
    					<a style="cursor: pointer;" href="#"><span class="ic"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index_icon_3.png";?>"></span> 同城当日达</a>&nbsp;
    				</li>
				</ul>
				 <script>
		        ...
		        <div class="notice f-r">
		        	...
		        	<div class="tabs">
		    				...
		    				<div class="tab-cnt">
								...
								<ul class="news-list">
									<?php foreach(Api::run('getAnnouncementList',8) as $key => $item){?>
										<li><a style='height:22px;' href='<?php echo IUrl::creatUrl("/site/notice_detail/id/".$item["id"]."");?>' class="limit" target="_blank"><?php echo isset($item['title'])?$item['title']:"";?></a>
										</li>
									<?php }?>
								</ul>
								</div>
	...
	<!--buying-->
		<div class="buying clearfix">
			<ul class="goods-list clearfix" style="width:1190px;margin-left:2px;">
				...
				<li class="xi">
					 <a class="goods-img" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>"  target="_blank">
						<img class="jImg" src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/170/h/170");?>"><div class="shine">&nbsp;</div>
					</a>
					<a class="goods-name" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>" title="<?php echo isset($item['name'])?$item['name']:"";?>"  target="_blank">
			 ...
			 <div class="tab-cnt">
            	...
            	<div class="tab-item"  <?php if($key==0){?>style='display:block'<?php }?>>
                	<ul class="goods-list clearfix">
                    	...
                    	<li>
	                         <a class="goods-img"  target="_blank" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>">
	                            <img class="jImg" src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/170/h/170");?>"><div class="shine">&nbsp;</div>
	                        </a>
	                        <a class="goods-name red-a" target="_blank" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>" title=" <?php echo isset($item['name'])?$item['name']:"";?>">
	                            <?php echo isset($item['name'])?$item['name']:"";?><span class="txt-red"></span>
	                        </a>
	                        <div class="goods-price">
	                            <span class="p-normal">￥<?php echo isset($item['sell_price'])?$item['sell_price']:"";?></span>
			...
			<div class="fl-title clearfix">
				...
				<ul class="fl-cat">
					<?php foreach($base['child'] as $key => $second){?>
								<li><a href="site/pro_list/cat/<?php echo isset($second['id'])?$second['id']:"";?>" target="_blank"><?php echo isset($second['name'])?$second['name']:"";?></a>|</li>
					<?php }?>
								<li><a href="site/pro_list/cat/<?php echo isset($base['id'])?$base['id']:"";?>" style="font-size: 12px;"target="_blank">更多</a></li>
				</ul>
			</div>
			<div class="fl-cnt clearfix">
					...
					<div class="fl-rcmd-bg ad-shine">
						<div class="keyword">
							...
							<?php foreach($hotCat[$base['id']] as $key => $hot){?>
								...
								<a href="<?php echo IUrl::creatUrl("site/pro_list/cat/".$hot['id']."");?>" class="key red-a"target="_blank"><?php echo isset($hot['name'])?$hot['name']:"";?></a>
							<?php }?>
							<?php }?>
						</div>
				...
				<div class="fl-rcmd1 f-l" >
					<div class="fl-rcmd-bg1 ad-shine" >
						...
						<?php echo Ad::show("首页楼层".$Kad."-大广告",0,1);?>
					</div>
				</div>
				<!--分层轮播广告-->
				<!--分类产品列表-->
                <div class="f-r">
				    <ul class="goods-list clearfix">
				    	<?php foreach($base['goods'] as $gk => $goods){?>
						<?php if($gk>=6){?>
						<?php break?>
						<?php }?>
					    	<li>
					        <a class="goods-img" href="<?php echo IUrl::creatUrl("/site/products/id/".$goods['id']."");?>" title="<?php echo isset($goods['name'])?$goods['name']:"";?>" target="_blank">
					            <img class="jImg" alt="<?php echo isset($goods['name'])?$goods['name']:"";?>" src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$goods['img']."/w/180/h/180");?>" target="_blank">
								<div class="shine">&nbsp;</div>
					        </a>
					        <a class="goods-name red-a" href="<?php echo IUrl::creatUrl("/site/products/id/".$goods['id']."");?>" title="<?php echo isset($goods['name'])?$goods['name']:"";?>" target="_blank">
		...
		<div class="big-pro">
	       <div class='seller_list'>
		 		<?php foreach($base['seller'] as $key => $seller){?>
					<a href="<?php echo IUrl::creatUrl("/site/home/id/".$seller['id']."");?>" target="_blank"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$seller['logo_img']."/w/119/h/60");?>"/></a>
				<?php }?>
		 	</div>
		</div>
		 <!--floor floor-1-->

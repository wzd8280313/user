...
class System extends IController
{
	...
	function test_sendmail()
	{
		...
		/*$site_config['smtp']='smtp.163.com';
		$site_config['email_type']=1;
		$site_config['mail_address']='15313086535@163.com';
		$site_config['name']='wangzhande';
		$site_config['smtp_user']='15313086535@163.com';
		$site_config['smtp_pwd']='107593184wzd';
		$site_config['smtp_port']=25;
		
		$test_address='380553326@qq.com';*/

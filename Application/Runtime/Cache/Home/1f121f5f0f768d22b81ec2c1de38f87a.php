		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo (IMG_URL); ?>goods1.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo (IMG_URL); ?>goods2.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo (IMG_URL); ?>goods3.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo (IMG_URL); ?>goods4.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo (IMG_URL); ?>goods5.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo (IMG_URL); ?>goods6.jpg" alt="" /></a></dt>
